                            ...
                            {visibleFields.map((field, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {/* Value */}
                                        <div className="min-h-11 w-full rounded-lg  bg-white px-3.5 py-2.5 text-sm text-slate-800  transition-colors dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200">
